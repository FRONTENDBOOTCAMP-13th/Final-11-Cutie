    ...
    <div className='w-[315px] h-[469px] laptop:w-[400px] laptop:h-[587px] border rounded-2xl p-5'>
      <div className='flex flex-col gap-3 laptop:gap-[27px]'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <select name="bank" id="bank" className="border w-full rounded-xs h-[34px] normal-14 text-font-400 border-font-900 pl-2">
        ...
        <div className=''>
          ...
          <input type="tel" placeholder="숫자로만 입력해주세요" className='border rounded-xs normal-14 w-full h-[34px] p-2.5'/>
        </div>
    ...
    <div className='w-[315px] h-[469px] laptop:w-[400px] laptop:h-[587px] border rounded-2xl p-5'>
      <div className='flex flex-col gap-4 laptop:gap-[30px]'>
        ...
        <div className=''>
          ...
          <input type="tel" placeholder="이메일을 입력해주세요" className='border rounded-xs normal-14 w-full h-[34px] p-2.5'/>
        </div>
        ...
        <div className=''>
          ...
          <input type="text" placeholder="250808-250808" className='bg-primary-50 rounded-xs normal-14 w-full h-[34px] p-2.5'/>
        </div>

        {/* 주소 */}
        <div className=''>
          <p className='semibold-14 pb-2'>주소</p>
          <input type="tel" placeholder="주소를 입력해주세요" className='border rounded-xs normal-14 w-full h-[34px] p-2.5'/>
        </div>
    ...
    <div className='w-[315px] h-[469px] laptop:w-[400px] laptop:h-[587px] border rounded-2xl p-5'>
      <div className='flex flex-col gap-4 laptop:gap-[30px]'>
        ...
        <div className=''>
          ...
          <input type="text" placeholder="25080808" className='bg-primary-50 rounded-xs normal-14 w-full h-[34px] p-2.5'/>
        </div>
