    ...
    <div className='w-[393px] h-[381px] mobile:w-[587px] mobile:h-[596px] laptop:w-[684px] laptop:h-[691px] p-6 mobile:p-10 laptop:p-[43px] laptop:pt-[64px] laptop:pb-[64px] rounded-2xl bg-primary-50 flex flex-col gap-3 mobile:gap-10'>
      <div className='flex flex-col gap-3 mobile:gap-6'>
        ...
        <div className='flex flex-col gap-2.5'>
          ...
          <input type="tel" placeholder="1234 5678 9012 3456" className='bg-bg border-secondary-200 border w-full h-[28px] mobile:h-[40px] laptop:h-[47px] p-2.5 rounded-sm normal-14 laptop:text-[16px]'/>
        </div>
        ...
        <div className='flex flex-col gap-2.5 '>
            ...
            <div className='flex gap-6'>
              {/* 월 드롭다운 */}
              <div className=''>
                <select name="birthMonth" id="birthMonth" className='w-[103px] h-[35px] bg-bg border border-secondary-200 rounded-sm normal-14 laptop:text-[16px] p-[5px] mobile:h-[47px] laptop:h-[59px]'>
        ...
        <div className='flex gap-6'>
            ...
            <div className='flex flex-col gap-2.5'>
              ...
              <input type="tel" placeholder="카드 비밀번호 앞 2자리를 입력해주세요." className='bg-bg border-secondary-200 border w-[160px] h-[28px] p-2.5 rounded-sm normal-10 mobile:h-[41px] mobile:w-[241px] laptop:w-[287px] laptop:h-[49px] mobile:text-[14px] laptop:text-[16px]'/>
            </div>
            {/* 소유주 생년월일 */}
            <div className='flex flex-col gap-2.5'>
              <p className='bold-14 laptop:text-[16px]'>소유주 생년월일</p>
              <input type="tel" placeholder="예)250808" className='bg-bg border-secondary-200 border w-[160px] h-[28px] p-2.5 rounded-sm normal-10 mobile:h-[40px] mobile:w-[241px] laptop:w-[287px] laptop:h-[49px] mobile:text-[14px] laptop:text-[16px]'/>
            </div>
        </div>
    ...
    <div className='w-[393px] h-[381px] mobile:w-[587px] mobile:h-[596px] laptop:w-[684px] laptop:h-[691px] p-6  mobile:p-10 laptop:p-[43px] laptop:pt-[64px] laptop:pb-[64px] rounded-2xl bg-primary-50 flex flex-col gap-6 mobile:gap-10'>
      <div className='flex flex-col gap-3 mobile:gap-6'>
        ...
        <div className='flex flex-col gap-2.5'>
          ...
          <input type="tel" placeholder="받는 분 성함을 입력해주세요." className='bg-bg border-secondary-200 border w-full h-[28px] mobile:h-[40px] laptop:h-[47px] p-2.5 rounded-sm normal-12 mobile:text-[14px] laptop:text-[16px]'/>
        </div>

        {/* 주소 */}
        <div className='flex flex-col gap-2.5'>
          <p className='bold-14 laptop:text-[16px]'>주소</p>
          <input type="tel" placeholder="받는 분 주소를 입력해 주세요." className='bg-bg border-secondary-200 border w-full h-[28px] mobile:h-[40px] laptop:h-[47px] p-2.5 rounded-sm normal-12 mobile:text-[14px] laptop:text-[16px]'/>
        </div>

        {/* 받는 사람 휴대폰 번호 */}
        <div className='flex flex-col gap-2.5'>
          <p className='bold-14 laptop:text-[16px]'>받는 사람 휴대폰 번호</p>
          <input type="tel" placeholder="받는 분 휴대폰 번호를 입력해주세요." className='bg-bg border-secondary-200 border w-full h-[28px] mobile:h-[40px] laptop:h-[47px] p-2.5 rounded-sm normal-12 mobile:text-[14px] laptop:text-[16px]'/>
        </div>
